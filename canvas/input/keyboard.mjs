...
export const OPERATOR_KEYS = [
    KEY_ALT, KEY_ALT_GRAPH, KEY_BACKSPACE, KEY_CAPS_LOCK, KEY_CONTROL, KEY_DELETE, KEY_ENTER, KEY_ESCAPE, KEY_FN, KEY_META, KEY_NUM_LOCK, KEY_OS, KEY_SCROLL_LOCK, KEY_SHIFT, KEY_SYMBOL,
